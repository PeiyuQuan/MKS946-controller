...
/* Generated from ../O.Common/MKS946.dbd */
...
int MKS946_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/uwchamber/epics/MKS946";
...
/* MKS946_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"MKS946_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(MKS946_registerRecordDeviceDriver(*iocshPpdbbase));
}
